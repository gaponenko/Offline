...
namespace {
  ...
  //================================================================
  VirtualDetectorId::enum_type getEntranceVD(const ExtMonFNALBuilding::CollimatorExtMonFNAL& col) {
  ...
  //================================================================
  VirtualDetectorId::enum_type getExitVD(const ExtMonFNALBuilding::CollimatorExtMonFNAL& col) {
